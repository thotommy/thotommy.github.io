...
export const MainTitleScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-10 h-[calc(100vh-110px)] font-medium mt-[-7rem]">
        <h1 className="text-5xl md:text-5xl lg:text-6xl xl:text-7xl">Tommy Ho</h1>
